...
#include "external/tao/pegtl/memory_input.hpp"
...
namespace tao::json::msgpack::events
{
   ...
   {
      pegtl::memory_input< pegtl::tracking_mode::lazy, pegtl::eol::lf_crlf, const char* > in( data, data + size, source ? source : "tao::json::msgpack::from_string", byte, line, column );
   ...
   {
      msgpack::events::from_string( consumer, data, size, source.c_str(), byte, line, column );
   }
