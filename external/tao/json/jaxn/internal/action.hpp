...
#include "external/tao/pegtl/change_action_and_states.hpp"
#include "external/tao/pegtl/change_states.hpp"
#include "external/tao/pegtl/nothing.hpp"
...
namespace tao::json::jaxn::internal
{
   ...
   template<>
   struct action< rules::single_string >
   ...
   template<>
   struct action< rules::single_binary >
