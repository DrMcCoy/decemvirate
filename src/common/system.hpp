...
#include "src/common/noreturn.hpp"
#include "src/common/fallthrough.hpp"
	...
	#define PLUGIN_EXPORT __declspec(dllexport)
		...
		#define DECEMVIRATE_LITTLE_ENDIAN 1
	#endif
	...
	#define PLUGIN_EXPORT __declspec(dllexport)
		...
		#define WIN32
				...
				#define DECEMVIRATE_BIG_ENDIAN 1
			#else
				#define DECEMVIRATE_LITTLE_ENDIAN 1
			#endif
		#endif
...
// Compatibility macro for dealing with the explicit bool cast problem.
	...
	#define DECEMVIRATE_EXPLICIT_OPERATOR_CONV
#else
	#define DECEMVIRATE_EXPLICIT_OPERATOR_CONV explicit
#endif
