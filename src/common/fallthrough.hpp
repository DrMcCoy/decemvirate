...
#ifndef COMMON_FALLTHROUGH_HPP
#define COMMON_FALLTHROUGH_HPP

/* DECEMVIRATE_FALLTHROUGH is an annotation to suppress compiler warnings about switch
 * cases that fall through without a break or return statement. DECEMVIRATE_FALLTHROUGH
 ...
 */
	...
	#define DECEMVIRATE_FALLTHROUGH [[clang::fallthrough]]
#elif __has_cpp_attribute(gnu::fallthrough)
	#define DECEMVIRATE_FALLTHROUGH [[gnu::fallthrough]]
	 ...
	 */
	#include <sal.h>
	#define DECEMVIRATE_FALLTHROUGH __fallthrough
#else
	#define DECEMVIRATE_FALLTHROUGH // Fallthrough
#endif
